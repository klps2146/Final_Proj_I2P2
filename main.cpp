...
#include <cstdio>
#include <cstring>
#include "llama.h"  // 假設你用的是 llama.cpp 的頭檔
...
int main(int argc, char **argv) {
    ...
    // std::string model_path = "C:/Users/klps2/OneDrive - NTHU/FINAL_PROJ/Resource/model/tinyllama-1.1b-chat-v1.0.Q4_0.gguf "; // 請修改為你自己的模型路徑
    // int ngl = 99;
    // int n_ctx = 2048;
